...
export const columnSetting = [
  ...
  { key: "title", label: "챌린지 제목", flex: 4.4, className: "text-gray-700 font-medium" },
  { key: "maxParticipant", label: "모집 인원", flex: 1.2 },
  { key: "createdAt", label: "신청일", flex: 1.2 },
  { key: "deadline", label: "마감 기한", flex: 1.2 },
  {
    key: "adminStatus",
    label: "상태",
    flex: 1.2,
