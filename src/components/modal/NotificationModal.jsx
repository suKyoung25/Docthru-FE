...
export default function NotificationModal({ notifications = [], onClose, buttonRef, onNotificationRead }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end sm:top-[53px] sm:right-18 xl:justify-center" onClick={onClose}>
      <div
        ref={modalRef}
        className="h-[465px] w-[343px] rounded-lg border-2 border-gray-200 bg-white p-4 shadow-xl max-sm:h-full max-sm:w-full xl:relative xl:top-auto xl:left-105"
      ...
      >
        ...
        <div className="max-h-full overflow-y-auto sm:max-h-[400px] [&::-webkit-scrollbar]:w-[5px] [&::-webkit-scrollbar]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-200 [&::-webkit-scrollbar-thumb:hover]:bg-gray-300">
          <ul>
