...
export default function page() {
  ...
  const [originalPageUrl, setOriginalPageUrl] = useState('https://frontend-fundamentals.com/code-quality/code/');
  ...
  return (
    <div className="relative">
      ...
      {isOriginalPageModal ? (
        ...
        >
          <EditorHeader isSubmit={true} content={content} challengeTitle="챌린지 제목" onDraft={onDraft} />
          <EditorSection
      ...
      {/* 임시 저장물이 존재하면 on */}
      {hasDraft && <DraftCheckModal setHasDraft={setHasDraft} onDraftModal={onDraftModal} />}

      {/* 임시 저장물 불러오기를 누르면 저장물 선택 모달 on */}
      {draftModal && <DraftModal onClose={onCloseDraftModal} isLoggedIn={true} onLoadItem={onLoadItem} />}
    </div>
  );
}
