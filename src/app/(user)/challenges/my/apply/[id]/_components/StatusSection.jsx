  ...
  return (
    <section>
      ...
      {(adminStatus === "DELETED" || adminStatus === "REJECTED") && (
        <div className="mt-4 flex h-[149px] w-full flex-col justify-between rounded-2xl border border-gray-200 bg-gray-50 p-4">
          <span className="text-center text-sm font-semibold text-gray-800">{text}</span>
          <p className="text-center text-sm font-medium md:text-base">{adminMessage}</p>
